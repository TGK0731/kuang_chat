      ...
      {message.sources && message.sources.length > 0 && (
        <div className="reference-list">
          ...
          {message.sources.map((s) => (
            <div key={s.index} className="reference-item">
        ...
        <div className="main-bottom">
          <div className="search-box">
            <input
              ...
              placeholder={isRagActive ? "基于知识库提问..." : "在这里输入提示"}
            />
          ...
          <p className="bottom-info">kuangAI 可能会显示不准确的信息，请仔细检查其回复。</p>
        </div>
      </div>
    </div>
  );
